...
namespace FinProj.ViewModels
{
    ...
    public class EmptyCartPageViewModel : BaseViewModel
    {
        ...
        private static EmptyCartPageViewModel emptyEmptyCartPageViewModel;
        ...
        public static EmptyCartPageViewModel BindingContext =>
            emptyEmptyCartPageViewModel = PopulateData<EmptyCartPageViewModel>("errorAndEmpty.json");
        ...
        {
            var file = "FinProj.Data." + fileName;
