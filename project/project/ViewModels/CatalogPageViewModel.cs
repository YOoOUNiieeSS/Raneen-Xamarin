    ...
    public class CatalogPageViewModel : BaseViewModel
    {
        ...
        private void AddFavouriteClicked(object obj)
        {
            if (obj is Product product)
            {
                ...
                Application.Current.MainPage.DisplayAlert("clicked", "Fav", "ok");
                //List<users> _users= (List<users>) CartProductListDatabase.GetAllusers();
                // CartProductListDatabase.AddProductToWishList(product,_users[0].ID);
            }
        }
        ...
        private void AddToCartClicked(object obj)
        {
            if (obj is Product product)
            {
                //Application.Current.MainPage.DisplayAlert("Add", product.Name, "OK");
                CartProductListDatabase.AddProductToCartList(product);
            }
